    ...
    aux.Fonts['Manga'] = [
        {
            ...
            Lancamentos:function(){
                ...
                WebApp.Ajax('https://mangahosted.com/',''+async function(Code,Result){
                    ...
                    Result.find('#dados .ekfaA.w-row').each(function( index ){
                        (aux.inicial['Manga']).push({
                            'img':$(this).find('.column-img img').attr('src'),
                            'nome':$(this).find('.column-img img').attr("alt"),
                            'ep':$(this).find(".column-content  .content-lancamento .chapters .btn-caps").first().text(),
                            'link':$(this).find(".column-img a").attr("href")
                        });
                    });
                    //sleep(1000);
                    swap("Manga");
